<!--Footer Section ======================-->
<footer class="footer-section full-width-section bg-secondary position-relative">
    <div class="container">
        ...
        <div class="copyright d-flex flex-column gap-2 flex-lg-row justify-content-lg-between align-items-lg-center text-center text-sm-start">
            ...
            <p class="mb-0">&copy; 2023, Architronix, All Rights Reserved</p>
        </div>
    </div>
    <!-- container -->
</footer>
...
<script src="../../../cdn.jsdelivr.net/gh/studio-freight/lenis%401.0.29/bundled/lenis.min.js"></script>
...
<script src="../../../unpkg.com/typed.js%402.1.0/dist/typed.umd.js"></script>
