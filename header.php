...
<head>
		...
		<link rel="shortcut icon" type="images/png" href="assets/images/logo/nb-mini.jpg">
	...
	<body>
		<div class="page">
			...
			<!--Header Section ======================-->
			<header class="header-section header-1 sticky-navbar header-bg-1">				
				<nav class="navbar navbar-expand-xl navbar-light nav-border hover-menu" aria-label="Offcanvas navbar large">	
					<div class="container-fluid max-width">										
						...
						<div class="offcanvas offcanvas-end" tabindex="-1" id="architronixNavbar" aria-labelledby="architronixNavbarLabel">
							...
							<ul class="navbar-nav justify-content-end flex-grow-1 align-items-xl-center">
								...
								<li class="nav-item dropdown">
									<a class="nav-link active d-flex gap-2 align-items-center" aria-current="page" href="index.php" aria-label="nav-links">
										Home
									</a>								
								</li>

								<li class="nav-item">
									<a class="nav-link" href="project-archive.php">
										Projects										   
									</a>									
								</li>	
												...
												<div class="row g-0">
													<div class="col-xl-3">															
														<div class="d-flex gap-30 flex-column py-40 ps-30 pe-40">
															<div class="menu-description">
																<a href="services.html" class="menu-heading text-decoration-none link-hover-animation-1 pb-1">Residential Design</a>
																<p class="small mb-0 pt-10">Everything from concept to completion</p>
															</div>	
															<!-- menu-description -->
															<div class="menu-description">
																<a href="services.html" class="menu-heading text-decoration-none link-hover-animation-1 pb-1">Commercial Design</a>
																<p class="small mb-0 pt-10">Focuses on optimizing functionality and aesthetics</p>
															</div>	
															<!-- menu-description -->
															<div class="menu-description">
																<a href="services.html" class="menu-heading text-decoration-none link-hover-animation-1 pb-1">Space Planning</a>
													...
													<div class="col-xl-3">															
														<div class="d-flex gap-30 flex-column py-40 ps-30 pe-40 separator h-100">
															<div class="menu-description">
																<a href="services.html" class="menu-heading text-decoration-none link-hover-animation-1 pb-1">Color Consultation</a>
																<p class="small mb-0 pt-10">We help you choose the perfect palette</p>
															</div>	
															<!-- menu-description -->
															<div class="menu-description">
																<a href="services.html" class="menu-heading text-decoration-none link-hover-animation-1 pb-1">Project Management</a>
																<p class="small mb-0 pt-10">We oversee every detail for a successful project</p>
															</div>	
															<!-- menu-description -->
															<div class="menu-description">
																<a href="services.html" class="menu-heading text-decoration-none link-hover-animation-1 pb-1">Custom Furnishings</a>
													...
													<div class="col-xl-3">															
														<div class="d-flex gap-30 flex-column py-40 ps-30 pe-40 separator h-100">
															<div class="menu-description">
																<a href="services.html" class="menu-heading text-decoration-none link-hover-animation-1 pb-1">Concept Development</a>
																<p class="small mb-0 pt-10">Develop a design concept</p>
															</div>	
															<!-- menu-description -->
															<div class="menu-description">
																<a href="services.html" class="menu-heading text-decoration-none link-hover-animation-1 pb-1">Revamps & Remodels</a>
														...
														<div class="menu-image-wrapper position-relative h-100">
															...
															<div class="menu-image-contents px-3">
																...
																<div class="architronix-button">
																	<a href="contact.php" class="btn btn-secondary d-inline-flex gap-10 w-100" target="_blank">Lets Talk							
										...
										<div class="row">
											<div class="col-lg-6">
												<div class="d-flex flex-column">
													<a class="dropdown-item" href="about-us.html" aria-label="single-pages"><span class="separator">About Us</span></a>										
													<a class="dropdown-item" href="services.html" aria-label="single-pages"><span class="separator">Services</span></a>	
													<a class="dropdown-item" href="project-single.html" aria-label="single-pages"><span class="separator">Project Single</span></a>
													<a class="dropdown-item" href="shop-single.html" aria-label="single-pages"><span class="separator">Shop Single</span></a>
												</div>
											</div>
											<div class="col-lg-6">
												<div class="d-flex flex-column dropdown-items-separator separator">
													<a class="dropdown-item" href="shop-archive.html" aria-label="single-pages"><span class="separator">Shop Archive</span></a>							
													<a class="dropdown-item" href="team.html" aria-label="single-pages"><span class="separator">Team</span></a>								
													<a class="dropdown-item" href="team-single.html" aria-label="single-pages"><span class="separator">Team Single</span></a>
													<a class="dropdown-item" href="contact.php" aria-label="single-pages"><span class="separator">Contact</span></a>
												</div>
								...
								<!-- <li class="nav-item dropdown ">
									...
									<ul class="dropdown-menu ">
										<li><a class="dropdown-item" href="blog-archive.html" aria-label="single-pages"><span class="separator">Blog Archive</span></a></li>										
										<li><a class="dropdown-item" href="blog-single.html" aria-label="single-pages"><span class="separator">Blog Single</span></a></li>										
										<li><a class="dropdown-item" href="blog-left-sidebar.html" aria-label="single-pages"><span class="separator">Blog Left Sidebar</span></a></li>										
										<li><a class="dropdown-item" href="blog-right-sidebar.html" aria-label="single-pages"><span class="separator">Blog Right Sidebar</span></a></li>						
									</ul>
								</li> -->
